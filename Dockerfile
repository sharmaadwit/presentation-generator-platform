...
# Copy frontend files individually to ensure they're available
...
RUN pwd
RUN find /app/frontend/ -name "package.json" -type f
...
# Copy backend files individually to ensure they're available
